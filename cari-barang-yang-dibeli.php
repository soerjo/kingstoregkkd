        ...
        $('#search').change(function() {
          ...
          $.ajax({
            ...
            success: function(data) {
              ...
              var markup = "<tr><td></td><td>" + data.no_kwitansi + "<input type=\"hidden\" name=\"idbarangterbeli\" id=\"idbarangterbeli\" value=" + data.id_barang_terbeli + " /></td><td>" + data.jumlah_barang_dibeli + "</td><td>" + data.total_harga_pembelian + "</td><td>" + data.nama_barang + "</td><td><form method=\"post\" action="
              "><input type=\"file\" name=\"uploadreceipt\" id=\"uploadreceipt\" multiple=\"multiple\"> <input type=\"submit\">Upload</button></form><td/></tr>";
